<?php
#	$Id: profile.inc.php 34 2012-05-10 02:58:13Z along $
#
...
switch($action){
	...
	default:
		...
		$group_set['max_flow_down'] = $group_set['max_flow_down'] ? $group_set['max_flow_down'] : __('unlimit');
		$group_set['max_flow_view'] = $group_set['max_flow_view'] ? $group_set['max_flow_view'] : __('unlimit');
		$group_set['max_folders'] = $group_set['max_folders'] ? $group_set['max_folders'].' '.__('piece') : __('unlimit');
		$group_set['max_files'] = $group_set['max_files'] ? $group_set['max_files'].' '.__('piece') : __('unlimit');
		...
		if($rs['user_file_types']){
			...
			$group_set['user_file_types'] = $group_set['group_file_types'] ? $group_set['group_file_types'] : __('unlimit');

		}
		if($rs['user_store_space']){
			$group_set['max_storage'] = $rs['user_store_space'];
		}else{
			$group_set['max_storage'] = $group_set['max_storage'] ? $group_set['max_storage'] : __('unlimit');
		}
		unset($rs);
