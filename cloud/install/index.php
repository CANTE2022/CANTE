...
$sqlfile = PHPDISK_ROOT.'install/install.sql';
...
<?php }?>
    <p class="title">伍六Ｅ盘 <?php echo __('install_guide') ?></p>
    <hr noshade="noshade" />
<?php
if(!$step){
?>
...
<p>&nbsp;</p>
<p align="center">欢迎使用，安装向导会指引您安装整个系统。全网精品源码分享群：474381515</p>
<p>&nbsp;</p>
<hr noshade="noshade" />
<p align="right">
...
?>
    <p>伍六Ｅ盘（高仿永硕Ｅ盘）二次开发于 PHPDisk 网络硬盘 是一款基于PHP+MySQL的强大的网络硬盘管理系统，您可以将一些资料通过网络上传到您的系统中，以一种图形界面的方式，方便的管理您每一个文件。方便的异地办公，资料的保存将会是您的首选。全网精品源码分享群：474381515</p>
    <hr noshade="noshade" />
    <p align="right">
...
<?php 
	...
	$filestores_dir = PHPDISK_ROOT.'up/';
	...
	$chk_template_dir = dir_writeable($template_dir) ? 1 : 0;
	$chk_plugins_dir = dir_writeable($plugins_dir) ? 1 : 0;
	if($short_open_tag && $chk_system_dir && $chk_filestores_dir && $chk_template_dir && $chk_plugins_dir){
		$install_halt =0;
	}else{
		$install_halt =1;
	}
?>
    ...
    <p><?php echo __('welcome_to_use') ?> 伍六Ｅ盘 ，<?php echo __('install_settings') ?>: </p>
    <ul>
      ...
      <li><?php echo $template_dir ?> <?php echo __('check_dir1') ?></li>
	  <li><?php echo $template_dir ?> <?php echo __('check_dir2') ?>：<?php output_txt($chk_template_dir,1); ?></li>
...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        ...
        <td><input type="text" value="root" name="dbuser" class="formfield" style="width:150px" onclick="this.value='';"></td>
      </tr>
      <tr>
...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
		...
		<input type="text" value="这里填数据库名称" name="dbname1" id="dbname1" class="formfield" style="width:150px" onclick="this.value='';"></td>
      </tr>
      <?php
      if($list_db){
      ?>
...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      <tr>
        ...
        <td><input type="text" value="admin" name="username" class="formfield" style="width:150px"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" value="ezqqw@vip.qq.com" name="email" class="formfield" style="width:150px"></td>
      </tr>
    </table>
...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      <tr>
        ...
        <td><input name="site_title" type="text" class="formfield" style="width:200px" value="伍六Ｅ盘" maxlength="50"></td>
      </tr>
      <tr>
...
write_file(PHPDISK_ROOT.'system/install.lock','伍六Ｅ盘 安装时间! Time:'.date("Y-m-d H:i:s"));
echo $msg;
if($flag){
	exit;
}
?>
    ...
    <hr noshade="noshade" />
    <p align="right"><?php echo __('phpdisk_official_site') ?></p>
<?php
	}
}
@unlink($setting_file);
